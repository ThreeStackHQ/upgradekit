...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border border-zinc-700 bg-zinc-900 p-4 shadow-lg transition-all",
...
export { Toast, ToastTitle, ToastDescription, ToastViewport, ToastProvider };
